      ...
      <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 relative">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="ml-4 px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold shadow hover:bg-blue-700 transition-all duration-300 ease-out hover:scale-105 absolute right-6 top-6 relative group"
